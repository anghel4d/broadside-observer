...
Anoptic indoor maps have modal bass and occlusion that geometric rays fake. Raghuvanshi 2010 is the SIGGRAPH wave-bake that became Microsoft Project Acoustics / Triton: simulate Helmholtz-ish transients offline, play encoded IRs online. Different from FDTD-at-runtime (1682 Botteldooren) and from FMM BEM 1171–1175.
...
Bake assumes static geometry; opening a door is a portal/occlusion extra (later 1735). Not realtime FDTD. Do not remint Helmholtz FMM cluster 1163/1171–1175/1178.
