...
Non-blocking THE work-stealing deque under adversarial multiprogramming—the structural precursor to Chase–Lev.
...
- User-level work-stealing scheduler analyzed against an adversarial kernel process scheduler.
