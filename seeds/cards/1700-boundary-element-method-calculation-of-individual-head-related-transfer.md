...
Can't put every player in anechoic. Scan a mesh, solve rigid BEM, get an HRTF. Part I is the rigid-model calculation (impedance in part II, not in this harvest). Anoptic photogrammetry → HRTF path starts here, then HUTUBS simulated set (1758).
