...
see:
  - "1726-progressive-perceptual-audio-rendering-of-complex-scenes"
---
...
The audio-thread analog of impostors. Tsingos/Gallo/Drettakis SIGGRAPH 2004 is the perceptual many-source paper (INRIA). Anoptic battles: cluster by location + loudness + maskee, then spatialize the cluster. Systems sequel: Moeck 2007 progressive (1726).
