...
see:
  ...
  - "1706-perceptual-audio-rendering-of-complex-virtual-environments"
---
...
GRID COMMAND has platoons, not one gun. Schissler & Manocha 2017 TOG scale GSound-class propagation to many sources (budget, clustering, shared paths). Pair with Tsingos 2004 perceptual clustering (1706) — that one is psychoacoustic grouping; this is the systems tracer.
