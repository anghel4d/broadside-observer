...
CPU FDTD doesn't fill a bake farm. Mehra et al. 2012 TVCG is the GPU wave kernel card in the UNC stack (before equivalent-source outdoor). Anoptic bake nodes: this stencil, then encode with 1670 — don't run it in the 16 ms frame.
