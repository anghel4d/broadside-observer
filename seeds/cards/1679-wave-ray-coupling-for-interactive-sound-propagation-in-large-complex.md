...
- **UNC + Lin.** Same group as equivalent-source outdoor (1685) and GSound.
- **SIGGRAPH Asia 2013 TOG.** Harvest coverage `hybrid`.

## Caveats

Interface matching is the hard part (energy leaks, latency). Not a shipping Triton bake. Not KW-boundary DWM 1744 (different hybrid).
