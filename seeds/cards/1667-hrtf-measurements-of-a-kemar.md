...
- **Measured, not BEM.** Contrast Katz 2001 numerical HRTF (1692).

## Caveats

One (two-pinna) dummy, not your head. Far-field; near-field ILD/ITD need Brungart 1999 (1691). Do not remint Finding Fast Filters 1091 (HRIR convolution codegen is a different card). Not CIPIC (1676).
