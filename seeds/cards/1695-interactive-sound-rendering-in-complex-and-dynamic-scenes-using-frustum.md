...
see:
  ...
  - "1696-ad-frustum-adaptive-frustum-tracing-for-interactive-sound-propagation"
---
...
- **GAMMA.** Precursor to AD-Frustum (1696) and GSound.
- **Interactive sound rendering** as the stated goal.

## Caveats

Frustum splitting cost vs accuracy. Geometric. Not BTMS. Overlap with beam tracing 1659 — different data structure (dynamic vs precomputed beam tree).
