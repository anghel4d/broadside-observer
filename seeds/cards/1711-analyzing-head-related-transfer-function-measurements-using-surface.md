...
HRTF grids are sparse. Evans/Angus/Tew 1998 JASA project measurements onto spherical harmonics — the spatial-basis card behind later MagLS/HOA thinking. Anoptic interpolation: SH or SUpDEq (1754), not bilinear on a 10° grid.
...
ITD/phase: naive SH on complex HRTF rings; later work time-aligns first (MagLS, ear alignment 1755). Order vs spatial aliasing. Not Ambisonic *scene* encoding — it's HRTF basis.
