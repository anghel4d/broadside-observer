...
cites:
  - title: "Physical Audio Signal Processing"
    ...
    doi: null
see:
  - "1753-reducing-the-dispersion-error-in-the-digital-waveguide-mesh-using"
...
If Anoptic wants a *tiny* wave toy (instrument body, small room) without FVTD machinery, DWM is the DSP-native formulation (Smith/Savioja lineage). Murphy 2007 IEEE SPM is the readable map; dispersion fixes are Savioja 2000 (1753).
