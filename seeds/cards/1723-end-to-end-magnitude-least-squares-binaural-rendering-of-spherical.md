...
Zaunschirm MagLS is HRTF-based decode. This I3DA paper is MagLS for *array → binaural* end-to-end (SMA recordings). Anoptic if you capture Ambisonic beds in the field; else 1672 is enough.
