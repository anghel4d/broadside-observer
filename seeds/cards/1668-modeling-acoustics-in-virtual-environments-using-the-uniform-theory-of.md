...
Games leak sound around doorframes and building corners. Specular beams (1667) go silent in shadow; UTD supplies a frequency-dependent diffracted path from each visible edge. This is the diffraction sibling of Funkhouser 1998, not Biot–Tolstoy–Medwin time-domain (1673).
...
UTD is an asymptotic high-frequency approximation (forced geometric), not a wave solution. Fails at grazing, low frequency, and thick/finite-impedance edges. Do not remint Svensson BTM 1673 as if it were this paper.
