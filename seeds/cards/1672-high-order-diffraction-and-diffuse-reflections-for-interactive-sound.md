...
cites:
  ...
  - title: "GSound: Interactive Sound Propagation for Games"
    ...
    doi: null
see:
  - "1668-modeling-acoustics-in-virtual-environments-using-the-uniform-theory-of"
...
First-order UTD (1668) is not enough for a city block. Schissler/Mehra/Manocha keep a path cache of diffracted and diffusely bouncing rays so large environments stay interactive. Game-audio path tracer, not a wave bake.
...
- **SIGGRAPH 2014.** UNC GAMMA; sibling of GSound AES 2011 (1679).

## Caveats

Still geometric (high-frequency). Diffuse is Monte-Carlo-ish, not a measured scattering coefficient (1751). Dynamic opening geometry needs later diffraction kernels (1696).
