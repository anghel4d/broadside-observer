...
see:
  - "1671-parametric-directional-coding-for-precomputed-sound-propagation"
...
This is the 'call the middleware' card for Anoptic: Raghuvanshi/Tennant/Snyder 2017 ASA is the *productization* of 1669–1671. Gears-era Microsoft spatial audio. Use when you want the shipping contract, not the SIGGRAPH encoding math.
...
Abstract-length vs the TOG encoding papers. Static-world bake; live destruction needs portals (1735) or 2D wave (1754). Not GSound (ray/UTD), not MagLS.
