...
## Goal
Survey ~1000 NEW candidate papers/works (no modern LLM/transformer/deep-RL agent stack), keep top 250 as seed cards 194–416.
...
## Counts
- Merged unique candidates: **729**
- Top seeds written: **193** (cards `194`–`500`)
- Pool breakdown: `{'engine': 50, 'gameai': 49, 'realtime': 22, 'hpc': 76, 'graphics': 53}`
- Memory-allocation seeds (≥10 required): **27**
- ECS seeds (≥10 required): **14**
